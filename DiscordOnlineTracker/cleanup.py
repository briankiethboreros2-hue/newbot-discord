    ...
    async def demote_member(self):
        ...
        try:
            ...
            if imperius_role and inactive_role:
                ...
                # Store demotion time in state
                self.bot.state.demoted_users[self.member.id] = datetime.now()
    ...
    async def promote_member(self):
        ...
        try:
            ...
            if imperius_role and inactive_role:
                ...
                if hasattr(self.bot, 'state') and self.member.id in self.bot.state.demoted_users:
                    del self.bot.state.demoted_users[self.member.id]
